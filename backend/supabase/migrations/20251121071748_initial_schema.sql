...
CREATE TABLE IF NOT EXISTS ehr.message_receipts (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(message_id) REFERENCES ehr.messages (id), 
	FOREIGN KEY(thread_id) REFERENCES ehr.message_threads (id), 
...
CREATE TABLE IF NOT EXISTS ehr.immunizations (
	...
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(encounter_id) REFERENCES ehr.encounters (id), 
	FOREIGN KEY(location_id) REFERENCES ref.hospital_departments (id), 
	FOREIGN KEY(performer_id) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.observation_components (
	...
	created_at TIMESTAMP WITH TIME ZONE DEFAULT now(), 
	PRIMARY KEY (id), 
	FOREIGN KEY(observation_id) REFERENCES ehr.observations (id)
)
...
CREATE TABLE IF NOT EXISTS ref.hospital_departments (
	...
	updated_at TIMESTAMP WITH TIME ZONE, 
	PRIMARY KEY (id), 
	FOREIGN KEY(hospital_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(head_id) REFERENCES core.users (id), 
	FOREIGN KEY(deputy_head_id) REFERENCES core.users (id), 
	FOREIGN KEY(parent_department_id) REFERENCES ref.hospital_departments (id), 
...
CREATE TABLE IF NOT EXISTS ehr.conditions (
	...
	recorder_id VARCHAR(36), 
	asserter_id VARCHAR(36), 
	notes JSON, 
	created_at TIMESTAMP WITH TIME ZONE DEFAULT now(), 
	updated_at TIMESTAMP WITH TIME ZONE, 
	PRIMARY KEY (id), 
	...
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(encounter_id) REFERENCES ehr.encounters (id), 
	FOREIGN KEY(recorder_id) REFERENCES core.users (id), 
	FOREIGN KEY(asserter_id) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.organization_patients (
	...
	FOREIGN KEY(organization_id) REFERENCES ref.hospitals (id) ON DELETE CASCADE, 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id) ON DELETE CASCADE
)
...
CREATE TABLE IF NOT EXISTS ehr.lab_result_notifications (
	...
	created_at TIMESTAMP WITH TIME ZONE DEFAULT now(), 
	PRIMARY KEY (id), 
	FOREIGN KEY(lab_result_id) REFERENCES ehr.lab_results (id), 
	FOREIGN KEY(notified_user_id) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.condition_stages (
	...
	created_at TIMESTAMP WITH TIME ZONE DEFAULT now(), 
	PRIMARY KEY (id), 
	FOREIGN KEY(condition_id) REFERENCES ehr.conditions (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.prescription_reminders (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(prescription_id) REFERENCES ehr.prescriptions (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.nurse_patient_assignments (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(nurse_id) REFERENCES ehr.nurses (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id)
)
...
CREATE TABLE IF NOT EXISTS ops.report_templates (
	...
	updated_at TIMESTAMP WITH TIME ZONE, 
	PRIMARY KEY (id), 
	FOREIGN KEY(organization_id) REFERENCES ref.hospitals (id), 
	UNIQUE (code), 
	FOREIGN KEY(created_by) REFERENCES core.users (id), 
	FOREIGN KEY(modified_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.insurances (
	...
	FOREIGN KEY(verified_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.clinical_notes (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(doctor_id) REFERENCES ehr.doctors (id), 
	FOREIGN KEY(encounter_id) REFERENCES ehr.appointments (id), 
	FOREIGN KEY(created_by) REFERENCES core.users (id), 
	FOREIGN KEY(locked_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS financial.charge_item_modifiers (
	...
	created_at TIMESTAMP WITH TIME ZONE DEFAULT now(), 
	PRIMARY KEY (id), 
	FOREIGN KEY(charge_item_id) REFERENCES financial.charge_items (id), 
	FOREIGN KEY(authorized_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.immunization_protocols (
	...
	created_at TIMESTAMP WITH TIME ZONE DEFAULT now(), 
	PRIMARY KEY (id), 
	FOREIGN KEY(immunization_id) REFERENCES ehr.immunizations (id)
)
...
CREATE TABLE IF NOT EXISTS financial.bills (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(account_id) REFERENCES ehr.patient_accounts (id), 
	FOREIGN KEY(submitted_by) REFERENCES core.users (id), 
	FOREIGN KEY(cancelled_by) REFERENCES core.users (id), 
	FOREIGN KEY(created_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ref.medication_product_synonym (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(product_id) REFERENCES ref.medication_product (id) ON DELETE CASCADE
)
...
CREATE TABLE IF NOT EXISTS core.users (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(organization_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(department_id) REFERENCES ref.hospital_departments (id), 
	FOREIGN KEY(admin_department_id) REFERENCES ref.hospital_departments (id), 
...
CREATE TABLE IF NOT EXISTS ehr.practitioner_roles (
	...
	FOREIGN KEY(practitioner_id) REFERENCES ehr.practitioners (id), 
	FOREIGN KEY(organization_id) REFERENCES ref.hospitals (id)
)
...
CREATE TABLE IF NOT EXISTS ref.medication_product (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(mnn_id) REFERENCES ref.mnn (id), 
	FOREIGN KEY(dosage_form_id) REFERENCES ref.dosage_form (id), 
	FOREIGN KEY(route_id) REFERENCES ref.route (id), 
	FOREIGN KEY(strength_unit_id) REFERENCES ref.unit (id), 
	FOREIGN KEY(manufacturer_id) REFERENCES ref.manufacturer (id)
)
...
CREATE TABLE IF NOT EXISTS ops.system_alerts (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(organization_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(department_id) REFERENCES ops.admin_departments (id), 
	FOREIGN KEY(user_id) REFERENCES core.users (id), 
	FOREIGN KEY(acknowledged_by) REFERENCES core.users (id), 
	FOREIGN KEY(resolved_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.messages (
	...
	clinic_id VARCHAR, 
	PRIMARY KEY (id), 
	FOREIGN KEY(sender_id) REFERENCES core.users (id), 
	FOREIGN KEY(recipient_id) REFERENCES core.users (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(parent_message_id) REFERENCES ehr.messages (id), 
	FOREIGN KEY(thread_id) REFERENCES ehr.message_threads (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.medical_records (
	...
	FOREIGN KEY(doctor_id) REFERENCES ehr.doctors (id), 
	FOREIGN KEY(hospital_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(appointment_id) REFERENCES ehr.appointments (id), 
	FOREIGN KEY(vital_signs_id) REFERENCES ehr.vital_signs (id), 
	FOREIGN KEY(created_by) REFERENCES core.users (id), 
	FOREIGN KEY(signed_by) REFERENCES core.users (id), 
	FOREIGN KEY(reviewed_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.encounters (
	...
	FOREIGN KEY(appointment_id) REFERENCES ehr.appointments (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(service_provider_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(part_of_encounter_id) REFERENCES ehr.encounters (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.lab_orders (
	...
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(ordered_by) REFERENCES ehr.doctors (id), 
	FOREIGN KEY(encounter_id) REFERENCES ehr.appointments (id), 
	FOREIGN KEY(cancelled_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.family_member_conditions (
	...
	created_at TIMESTAMP WITH TIME ZONE DEFAULT now(), 
	PRIMARY KEY (id), 
	FOREIGN KEY(family_member_id) REFERENCES ehr.family_member_histories (id)
)
...
CREATE TABLE IF NOT EXISTS financial.insurance_authorizations (
	...
	requesting_provider_id VARCHAR(36) NOT NULL, 
	servicing_provider_id VARCHAR(36), 
	status VARCHAR(20) NOT NULL, 
	decision_date DATE, 
	valid_from DATE, 
	valid_to DATE, 
	...
	updated_at TIMESTAMP WITH TIME ZONE, 
	PRIMARY KEY (id), 
	FOREIGN KEY(insurance_id) REFERENCES ehr.insurances (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	UNIQUE (authorization_number), 
	FOREIGN KEY(requesting_provider_id) REFERENCES ehr.doctors (id), 
	FOREIGN KEY(servicing_provider_id) REFERENCES ehr.doctors (id)
)
...
CREATE TABLE IF NOT EXISTS ops.scheduled_reports (
	...
	updated_at TIMESTAMP WITH TIME ZONE, 
	PRIMARY KEY (id), 
	FOREIGN KEY(template_id) REFERENCES ops.report_templates (id), 
	FOREIGN KEY(organization_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(created_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.nurse_shift_assignments (
	...
	FOREIGN KEY(nurse_id) REFERENCES ehr.nurses (id), 
	FOREIGN KEY(department_id) REFERENCES ref.hospital_departments (id), 
	FOREIGN KEY(replaced_nurse_id) REFERENCES ehr.nurses (id)
)
...
CREATE TABLE IF NOT EXISTS ops.blocked_time_slots (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(doctor_id) REFERENCES ehr.doctors (id), 
	FOREIGN KEY(schedule_id) REFERENCES ehr.doctor_schedules (id), 
	FOREIGN KEY(created_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ref.medication_price (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(presentation_id) REFERENCES ref.medication_presentation (id) ON DELETE CASCADE
)
...
CREATE TABLE IF NOT EXISTS ehr.medication_administrations (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(administered_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ref.medication_product_category (
	...
	FOREIGN KEY(product_id) REFERENCES ref.medication_product (id) ON DELETE CASCADE, 
	FOREIGN KEY(category_id) REFERENCES ref.category_tag (id) ON DELETE CASCADE
)
...
CREATE TABLE IF NOT EXISTS ehr.lab_results (
	...
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(lab_order_id) REFERENCES ehr.lab_orders (id), 
	FOREIGN KEY(medical_record_id) REFERENCES ehr.medical_records (id), 
	FOREIGN KEY(ordered_by) REFERENCES ehr.doctors (id)
)
...
CREATE TABLE IF NOT EXISTS ops.medication_administration_events (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(medication_id) REFERENCES ops.patient_medications (id), 
	FOREIGN KEY(nurse_id) REFERENCES ehr.nurses (id)
)
...
CREATE TABLE IF NOT EXISTS pharmacy_prescription_prices (
	...
	FOREIGN KEY(pharmacy_id) REFERENCES ehr.pharmacies (id), 
	FOREIGN KEY(prescription_id) REFERENCES ehr.prescriptions (id)
)
...
CREATE TABLE IF NOT EXISTS financial.charge_items (
	...
	performer_id VARCHAR(36), 
	performing_organization_id VARCHAR(36), 
	requesting_organization_id VARCHAR(36), 
	...
	FOREIGN KEY(appointment_id) REFERENCES ehr.appointments (id), 
	FOREIGN KEY(performer_id) REFERENCES core.users (id), 
	FOREIGN KEY(performing_organization_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(requesting_organization_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(cost_center_id) REFERENCES ref.hospital_departments (id), 
	FOREIGN KEY(account_id) REFERENCES ehr.patient_accounts (id), 
	FOREIGN KEY(entered_by) REFERENCES core.users (id), 
	FOREIGN KEY(bill_id) REFERENCES financial.bills (id), 
	FOREIGN KEY(part_of_id) REFERENCES financial.charge_items (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.radiology_reports (
	...
	UNIQUE (study_id), 
	FOREIGN KEY(study_id) REFERENCES ehr.radiology_studies (id), 
	FOREIGN KEY(radiologist_id) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.encounter_participants (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(encounter_id) REFERENCES ehr.encounters (id), 
	FOREIGN KEY(individual_id) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.claim_line_items (
	...
	created_at TIMESTAMP WITH TIME ZONE DEFAULT now(), 
	PRIMARY KEY (id), 
	FOREIGN KEY(claim_id) REFERENCES financial.insurance_claims (id)
)
...
CREATE TABLE IF NOT EXISTS ops.bulk_operations (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(organization_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(performed_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.medical_history (
	...
	PRIMARY KEY (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(recorded_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.lab_reports (
	...
	created_at TIMESTAMP WITH TIME ZONE DEFAULT now(), 
	PRIMARY KEY (id), 
	FOREIGN KEY(order_id) REFERENCES ehr.lab_orders (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id)
)
...
CREATE TABLE IF NOT EXISTS ehr.general_reports (
	...
	FOREIGN KEY(doctor_id) REFERENCES ehr.doctors (id), 
	FOREIGN KEY(encounter_id) REFERENCES ehr.appointments (id), 
	FOREIGN KEY(clinic_id) REFERENCES ref.hospitals (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.document_references (
	...
	FOREIGN KEY(medical_record_id) REFERENCES ehr.medical_records (id), 
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(authenticator_id) REFERENCES core.users (id), 
	FOREIGN KEY(custodian_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(encounter_id) REFERENCES ehr.appointments (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.allergy_reactions (
	...
	created_at TIMESTAMP WITH TIME ZONE DEFAULT now(), 
	PRIMARY KEY (id), 
	FOREIGN KEY(allergy_id) REFERENCES ehr.allergy_intolerances (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.vital_signs (
	...
	patient_id VARCHAR(36) NOT NULL, 
	medical_record_id VARCHAR(36), 
	measured_by VARCHAR(36) NOT NULL, 
	temperature FLOAT, 
	...
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(medical_record_id) REFERENCES ehr.medical_records (id), 
	FOREIGN KEY(measured_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.clinical_impressions (
	...
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(encounter_id) REFERENCES ehr.appointments (id), 
	FOREIGN KEY(assessor_id) REFERENCES core.users (id), 
	FOREIGN KEY(previous_id) REFERENCES ehr.clinical_impressions (id)
)
...
CREATE TABLE IF NOT EXISTS notification_template_usage (
	...
	FOREIGN KEY(notification_id) REFERENCES ops.notifications (id), 
	FOREIGN KEY(template_id) REFERENCES ops.notification_templates (id)
)
...
CREATE TABLE IF NOT EXISTS financial.payments (
	...
	FOREIGN KEY(received_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ops.patient_medications (
	...
	FOREIGN KEY(patient_id) REFERENCES ehr.patients (patient_id), 
	FOREIGN KEY(prescription_id) REFERENCES ehr.prescriptions (id), 
	FOREIGN KEY(prescribed_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ref.medication_presentation (
	...
	FOREIGN KEY(product_id) REFERENCES ref.medication_product (id) ON DELETE CASCADE, 
	FOREIGN KEY(pack_size_unit_id) REFERENCES ref.unit (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.practitioner_locations (
	...
	practitioner_role_id VARCHAR(36) NOT NULL, 
	location_id VARCHAR(36) NOT NULL, 
	PRIMARY KEY (practitioner_role_id, location_id), 
	FOREIGN KEY(practitioner_role_id) REFERENCES ehr.practitioner_roles (id), 
	FOREIGN KEY(location_id) REFERENCES ref.hospital_departments (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.practitioner_specialties (
	...
	FOREIGN KEY(practitioner_role_id) REFERENCES ehr.practitioner_roles (id), 
	FOREIGN KEY(specialty_id) REFERENCES ehr.specialties (id)
)
...
CREATE TABLE IF NOT EXISTS financial.insurance_claims (
	...
	status_reason TEXT, 
	billing_provider_id VARCHAR(36) NOT NULL, 
	rendering_provider_id VARCHAR(36), 
	referring_provider_id VARCHAR(36), 
	...
	FOREIGN KEY(billing_provider_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(rendering_provider_id) REFERENCES ehr.doctors (id), 
	FOREIGN KEY(referring_provider_id) REFERENCES ehr.doctors (id), 
	FOREIGN KEY(original_claim_id) REFERENCES financial.insurance_claims (id)
)
...
CREATE TABLE IF NOT EXISTS financial.financial_transactions (
	...
	FOREIGN KEY(posted_by) REFERENCES core.users (id), 
	FOREIGN KEY(reversed_by_id) REFERENCES financial.financial_transactions (id)
)
...
CREATE TABLE IF NOT EXISTS ref.locations (
	...
	FOREIGN KEY(department_id) REFERENCES ref.hospital_departments (id), 
	UNIQUE (code), 
	FOREIGN KEY(current_patient_id) REFERENCES ehr.patients (patient_id), 
	UNIQUE (fhir_location_id)
)
...
CREATE TABLE IF NOT EXISTS ehr.prescriptions (
	...
	FOREIGN KEY(hospital_id) REFERENCES ref.hospitals (id), 
	FOREIGN KEY(encounter_id) REFERENCES ehr.appointments (id), 
	FOREIGN KEY(prior_prescription_id) REFERENCES ehr.prescriptions (id), 
	FOREIGN KEY(created_by) REFERENCES core.users (id), 
	FOREIGN KEY(prescribed_by) REFERENCES core.users (id), 
	FOREIGN KEY(last_modified_by) REFERENCES core.users (id), 
	FOREIGN KEY(cancelled_by) REFERENCES core.users (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.specialties (
	...
	PRIMARY KEY (id), 
	UNIQUE (code), 
	FOREIGN KEY(parent_id) REFERENCES ehr.specialties (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.nurses (
	...
	UNIQUE (user_id), 
	FOREIGN KEY(user_id) REFERENCES core.users (id), 
	FOREIGN KEY(primary_department_id) REFERENCES ref.hospital_departments (id)
)
...
CREATE TABLE IF NOT EXISTS ehr.prescription_refills (
	...
	FOREIGN KEY(prescription_id) REFERENCES ehr.prescriptions (id), 
	FOREIGN KEY(pharmacy_id) REFERENCES ehr.pharmacies (id), 
	FOREIGN KEY(dispensed_by_id) REFERENCES core.users (id)
)
