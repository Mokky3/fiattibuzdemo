"""Enhanced Nurse portal messaging schemas for surgical edits integration."""
...
class SendMessageRequest(BaseModel):
    ...
    document_attachments: Optional[List[Dict[str, Any]]] = Field(default_factory=list, description="Document attachments (reports, lab results, imaging, prescriptions)")
...
class ConversationSummary(BaseModel):
    ...
    nurse_id: str = Field(..., description="Nurse ID")
...
class MessageThread(BaseModel):
    ...
    nurse_id: Optional[str] = Field(None, description="Nurse ID")
    fhir_conversation_id: Optional[str] = Field(None, description="FHIR Communication ID")
