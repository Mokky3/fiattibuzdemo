...
# Make this lazy - only check when actually used, not at import time
def _get_llm_base_url() -> str:
    """Get LLM base URL from environment variables."""
...
async def chat(
    ...
    """
    # Get LLM base URL (lazy check - only when actually used)
