    ...
    <header className="bg-[#4DB6B0] text-white shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-5 relative">
          {/* Search Bar */}
          <div className="flex items-center bg-white rounded-full px-4 py-1.5 shadow-inner hover:shadow-md focus-within:ring-2 focus-within:ring-white focus-within:ring-opacity-50">
            <input
              type="text"
              placeholder="SEARCH"
          ...
          <div className="relative" ref={dropdownRef}>
            <div
              ...
              className="w-9 h-9 rounded-full bg-gray-700 flex items-center justify-center text-white font-bold text-sm shadow-md hover:bg-gray-600 cursor-pointer"
            >
              {getUserInitials()}
            </div>
