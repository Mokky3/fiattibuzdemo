    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
      ...
      <div className={`max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8 transition-all duration-700 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 space-y-4 md:space-y-0">
          <h2 className="text-2xl font-bold bg-gradient-to-r from-[#5ACCC3] to-[#4DB6B0] bg-clip-text text-transparent">Reception Dashboard</h2>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4DB6B0] focus:border-transparent"
              />
            </div>
            
            {/* Quick Actions */}
            <button className="bg-[#4DB6B0] hover:bg-[#5ACCC3] text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-1/4 space-y-6">
            ...
            <div className="bg-white p-4 rounded-xl shadow border border-gray-100">
              <h3 className="font-semibold text-gray-700 mb-3">Quick Overview</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Total Today</span>
                  <span className="font-semibold text-[#4DB6B0]">24</span>
                </div>
                <div className="flex justify-between items-center">
          ...
          <div className="md:w-3/4 space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {stats.map((s, idx) => (
                <div key={idx} className="p-6 rounded-xl bg-white border border-gray-100 shadow hover:shadow-lg hover:scale-[1.02] transition-all">
                  <div className="flex items-center justify-between mb-4">
                    <div>{s.icon}</div>
                    <div className="text-3xl font-bold text-gray-800">{s.value}</div>
                  </div>
                  <div className="text-sm text-gray-600 mb-2">{s.title}</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow border border-gray-100">
                ...
                <div className="space-y-3">
                  {upcomingAppointments.map((apt) => (
                    <div key={apt.id} className="p-4 rounded-lg border border-gray-200 hover:border-[#4DB6B0] transition-colors">
              ...
              <div className="bg-white p-6 rounded-xl shadow border border-gray-100">
                ...
                <div className="space-y-3">
                  {tasks.map((t) => (
                    <div key={t.id} className={`p-4 rounded-lg border-l-4 transition ${getPriorityColor(t.priority)} ${t.completed ? 'bg-green-50 border-green-200' : 'bg-white border-gray-200'}`}>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3 flex-1">
                          ...
                          <span className={`flex-1 ${t.completed ? 'text-gray-500 line-through' : 'text-gray-800'}`}>
                            {t.task}
                          </span>
                        </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow border border-gray-100">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <button className="p-4 rounded-lg border border-gray-200 hover:border-[#4DB6B0] hover:bg-[#4DB6B0] hover:text-white transition-colors group">
                  <FiPhone className="text-2xl mb-2 text-[#4DB6B0] group-hover:text-white" />
                  <span className="text-sm font-medium">Call Patient</span>
                </button>
                <button className="p-4 rounded-lg border border-gray-200 hover:border-[#4DB6B0] hover:bg-[#4DB6B0] hover:text-white transition-colors group">
                  <FiUserPlus className="text-2xl mb-2 text-[#4DB6B0] group-hover:text-white" />
                  <span className="text-sm font-medium">Register Walk-In</span>
                </button>
                <button className="p-4 rounded-lg border border-gray-200 hover:border-[#4DB6B0] hover:bg-[#4DB6B0] hover:text-white transition-colors group">
                  <FiClipboard className="text-2xl mb-2 text-[#4DB6B0] group-hover:text-white" />
                  <span className="text-sm font-medium">Print Reports</span>
                </button>
                <button className="p-4 rounded-lg border border-gray-200 hover:border-[#4DB6B0] hover:bg-[#4DB6B0] hover:text-white transition-colors group">
                  <FiCalendar className="text-2xl mb-2 text-[#4DB6B0] group-hover:text-white" />
