    ...
    <header className="bg-[#4DB6B0] text-white shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="font-bold text-2xl tracking-wider">
          <Link to="/admin/dashboard" className="text-white no-underline hover:text-opacity-90 transition-all flex items-center">
        ...
        <div className="flex items-center space-x-5 relative">
          ...
          <div className="relative" ref={dropdownRef}>
            <div
              ...
              className="w-9 h-9 rounded-full bg-white text-[#4DB6B0] font-bold flex items-center justify-center cursor-pointer hover:bg-gray-100"
            >
              AD
            </div>
